...
export const adminAPI = {
  ...
  updateServerStatus: infrastructureAPI.updateServerStatus,
  ...
  execCommand: infrastructureAPI.execCommand,
  shutdownServer: infrastructureAPI.shutdownServer,
  restartServer: infrastructureAPI.restartServer,

  // Clusters
  getCluster: infrastructureAPI.getCluster,
  getClusterInfo: infrastructureAPI.getClusterInfo,
  createCluster: infrastructureAPI.createCluster,
  updateCluster: infrastructureAPI.updateCluster,
  deleteCluster: infrastructureAPI.deleteCluster,
