...
const mockProjectDetails: Record<string, AdminProjectDetail> = {
  "proj-1": {
    ...
    name: "Thanh toán trực tuyến",
    databases: [
      { id: "db-1", name: "payments-db", status: "running", cpu: "2 cores", memory: "8 GB" },
      { id: "db-2", name: "audit-db", status: "running", cpu: "1 core", memory: "4 GB" },
    ],
    backends: [
  ...
  "proj-2": {
    id: "proj-2",
    name: "Hệ thống báo cáo",
    databases: [{ id: "db-3", name: "reporting-db", status: "running", cpu: "1 core", memory: "4 GB" }],
  ...
  "proj-3": {
    id: "proj-3",
    name: "Ứng dụng loyalty",
    databases: [{ id: "db-4", name: "loyalty-db", status: "running", cpu: "1 core", memory: "2 GB" }],
  ...
  "proj-4": {
    id: "proj-4",
    name: "Quản lý kho",
    databases: [{ id: "db-5", name: "warehouse-db", status: "running", cpu: "2 cores", memory: "8 GB" }],
  ...
  "proj-5": {
    ...
    name: "Sàn thương mại điện tử",
    databases: [
      { id: "db-6", name: "orders-db", status: "running", cpu: "3 cores", memory: "12 GB" },
      { id: "db-7", name: "catalog-db", status: "running", cpu: "2 cores", memory: "8 GB" },
      { id: "db-8", name: "users-db", status: "running", cpu: "2 cores", memory: "8 GB" },
    ],
    backends: [
  ...
  "proj-6": {
    id: "proj-6",
    name: "Hệ thống đặt vé",
    databases: [{ id: "db-9", name: "booking-db", status: "running", cpu: "1 core", memory: "4 GB" }],
